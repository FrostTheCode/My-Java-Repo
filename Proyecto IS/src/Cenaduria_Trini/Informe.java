...
public class Informe extends JFrame {
	...
	public Informe() {
		...
		JButton btnVentaInfo = new JButton("Venta");
		btnVentaInfo.setBorder(new MatteBorder(3, 3, 3, 3, (Color) new Color(0, 0, 0)));
		btnVentaInfo.setBackground(new Color(143, 188, 143));
		btnVentaInfo.setFont(new Font("Tahoma", Font.PLAIN, 40));
		PanB.add(btnVentaInfo);
		
		JButton btnInsumosInfo = new JButton("Insumos");
		btnInsumosInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Insumos ins = new Insumos();
				ins.setVisible(true);
			}
		});
		btnInsumosInfo.setBorder(new MatteBorder(3, 3, 3, 3, (Color) new Color(0, 0, 0)));
		btnInsumosInfo.setBackground(new Color(143, 188, 143));
		btnInsumosInfo.setFont(new Font("Tahoma", Font.PLAIN, 40));
		PanB.add(btnInsumosInfo);
		
		JButton btnInformeInfo = new JButton("Informe");
		btnInformeInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		PanB.add(btnInformeInfo);
		btnInformeInfo.setBorder(new MatteBorder(3, 3, 3, 3, (Color) new Color(0, 0, 0)));
		btnInformeInfo.setBackground(new Color(143, 188, 143));
		btnInformeInfo.setFont(new Font("Tahoma", Font.PLAIN, 40));
		
		btnVentaInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Venta v = new Venta();
				v.setVisible(true);
			}
